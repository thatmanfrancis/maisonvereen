...
const articles = [
  {
    ...
    excerpt:
      "Not 'what fragrance do people want to wear?' That question has been asked by every house, answered by every house, and produced a world of beautiful things that smell largely the same. The question that started Maison Vereen was different. Harder. More personal.",
    date: "June 2024",
    readTime: "6 min read",
  },
  {
    ...
    excerpt:
      "The vision was never modest. It was never regional. It was never 'let's make a nice fragrance.' The vision was Africa's first serious luxury fragrance house. Built to the standard of the world's greatest houses. Uncompromising in craft. Unapologetic in origin.",
    date: "May 2024",
    readTime: "5 min read",
  },
  {
    ...
    excerpt:
      "Maison Vereen Edition I was not built quickly. The fragrance was developed with a master perfumer whose credentials are not decoration. The raw materials were sourced specifically from African regions — not as a story, but because those materials produce quality that cannot be replicated from elsewhere.",
    date: "April 2024",
    readTime: "7 min read",
  },
  {
  ...
  },
  {
    ...
    excerpt:
      "Some people arrive in rooms with noise. Others arrive with weight. The difference is not volume. It is not charisma. It is something more fundamental — a quality that precedes the entry. Maison Vereen was built for the weight-carriers.",
    date: "February 2024",
    readTime: "4 min read",
  },
  {
    ...
    excerpt:
      "Edition I is the beginning of a house designed to endure. Future editions. Future collections. Future spaces. Each one building on the last. Each one deepening the mythology of what Maison Vereen is.",
    date: "January 2024",
    readTime: "6 min read",
  },
];
      ...
      <main className="bg-charcoal">
        ...
        <section className="border-b border-white/5 pt-[72px]">
          <div className="max-w-[1400px] mx-auto px-8 md:px-14 py-20 md:py-24 space-y-5">
            ...
            <p
              className="text-[#5A5449] font-light max-w-[480px]"
              style={{ fontSize: "14px" }}
            >
          ...
          <div className="max-w-[1400px] mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-white/4">
              {articles.map((a, i) => (
                <article
                  key={i}
                  className="group bg-charcoal cursor-pointer hover:bg-white/15 transition-colors duration-500 anim-fade-up"
