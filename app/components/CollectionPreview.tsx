      ...
      <div className="max-w-[1400px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="relative min-h-[500px] lg:min-h-[660px] overflow-hidden bg-[#060608]">
            ...
            <Image src="/images/hero-bottle.png"
              alt="Maison Vereen Edition I — The Founding Expression"
              fill sizes="(max-width:1024px) 100vw, 50vw"
              className="object-cover object-center"
              style={{ opacity: 0.18, filter: "blur(6px) brightness(0.4) saturate(0.3)" }} />
            {/* Deep atmospheric layering */}
            <div className="absolute inset-0 bg-gradient-to-t from-[#060608] via-[#060608]/60 to-[#060608]/20" />
            <div className="absolute inset-0 bg-gradient-to-r from-[#060608]/80 via-transparent to-[#060608]/40" />
            {/* Warm glow at centre — suggests the presence of the bottle */}
            <div
              className="absolute inset-0 pointer-events-none"
              style={{
                background: "radial-gradient(ellipse 40% 60% at 55% 45%, rgba(180,130,40,0.08) 0%, transparent 70%)",
              }}
            />
            <div className="absolute bottom-8 left-8 space-y-1.5 z-10">
              ...
              <span className="block text-[#3A3028] font-light" style={{ fontSize: "9px" }}>
                Coming.
              </span>
            </div>
          </div>
          ...
          <div className="flex items-center px-10 md:px-16 lg:px-20 py-20 md:py-28 bg-[#0A0A0A]">
            <div className="max-w-[420px] space-y-9">
              ...
              >
                Collection One.
                <span className="block font-serif font-light text-[#C8BFB2] mt-2"
                  style={{ fontSize: "clamp(1rem, 1.8vw, 1.5rem)" }}>
                  250 numbered bottles.
                </span>
                <span className="block font-serif font-light mt-1"
                  style={{ fontSize: "clamp(1rem, 1.8vw, 1.5rem)", color: "#C9A84C" }}>
